	...
	if(divRequest == 'add')  {
		...
		$("#createOrderForm").unbind('submit').bind('submit', function() {
			...
			if(appname  ) {
	            	...
	            	'<strong><i class="glyphicon glyphicon-ok-sign"></i></strong> '+ response.messages + "Your token no is --> "+response.property_purchasertoken+
	            	' <br /> <br /> <a type="button" onclick="printOrder('+response.buyer_id+')" class="btn btn-primary"> <i class="glyphicon glyphicon-print"></i> Print </a>'+
...
function proppayinfo(){
    ...
    var appinfoinfo =  '<div class="container-fluid" id="appinfo">'+
 ...
 function jointappinfo(){
    var jointappinfo =  '<div class="container-fluid" id="appinfo">'+
                        '<div class="row clearfix">'+
                           ' <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">'+
                                '<div class="card">'+
                                    '<div class="header">'+
 ...
 function nominfo(){
    ...
    var nominfo =  '<div class="container-fluid" id="nominfo">'+
    '<div class="row clearfix">'+
    '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">'+
        '<div class="card">'+
            '<div class="header">'+
	...
	if(orderId) {		
		...
		$.ajax({
			...
			success:function(response) {
				...
				var mywindow = window.open('', 'Stock Management System', 'height=1508px ,width=1480px');
