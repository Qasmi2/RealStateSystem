...
<div class="container">
	...
	<table class="table" style="font-family:arial;font-size:12px; width:83% !important; margin-left:160px;">
				  ...
				  <tr style="line-height:15px; ">
					 <td colspan="12" style="text-align: right;border-bottom:none !important;"> Payment Amount Paid through CASH <b> RS.{{$propertyPrice}}/-</b></td>
				  </tr>
				  <tr style="line-height:15px;">
					<td colspan="12" style="text-align: right;border-bottom:none !important;">Total Received Amount <b> RS.{{$propertyPrice}}/-</b></td> 
				  </tr>
				  <tr style="line-height:15px;">
				  <td colspan="12" style="text-align: right;">Total Remaining Amount <b> RS.0/-</b></td>
				  </tr>
				  </tbody>
				</table> 
				...
				1<sup>st</sup> Installment Due Date: <b> 9-10-2019  -->
			</div>
			<div class="container">
	<div class="row">
