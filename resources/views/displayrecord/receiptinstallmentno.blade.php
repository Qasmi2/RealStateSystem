...
<body>
        ...
        <div style="width:750px; margin:0px auto; font-size:20px; line-height:25px; display:table;">
			...
			<div style="font-family:Calibri; font-size:30px; font-weight:bold;">INSTALLMENT AMOUNT</div>
			&nbsp;
			...
			<div style="font-family:Calibri; font-size:13px; font-weight:bold; line-height:16px; padding:15px 0;">
                ...
                <table style="font-family:Calibri;font-size:15px;">
				  ...
				  <tr style="border:none !important;line-height:15px;">
					 <td colspan="5" style="text-align: right;"> {{$number}}<sup>st</sup> Installment Amount Paid : {{$amount}}</td>
				  </tr>
				  <tr style="border:none !important;line-height:15px;">
					<td colspan="5" style="text-align: right;">Total Received Amount  RS. {{$totalpaid}}/-</td> 
				  </tr>
				  <tr style="border:none !important;line-height:15px;">
				  <td colspan="5" style="text-align: right;">Total Remaining Amount  RS. {{$remeaningAmount}}/-</td>
				  </tr>
				</table>
