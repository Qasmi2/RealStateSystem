                    ...
                    @foreach($payment as $te)
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 col-lg-6 col-sm-12" >
                                ...
                                <input id="tokenPayment" type="number" min="0" placeholder="Enter Token payment" class="form-control" name="tokenPayment" value="{{$te->tokenPayment}}" style="border: 1px solid red;">
                              
                            </div>       
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                <label for="remaningPaymentDate">Remaning Payment Date</label>
                                <input id="remaningPaymentDate" type="Date" placeholder="Enter Remaning Payment Date" class="form-control" name="remaningPaymentDate" value="{{$te->remaningPaymentDate}}" style="border: 1px solid red;">
